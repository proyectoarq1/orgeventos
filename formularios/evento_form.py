...
class EventoForm(Form):
    ...
    descripcion = TextField('Descripcion del evento', [validators.Length(min=4, max=700),validators.Required(message="Por favor ingrese una descripcion para el evento")])

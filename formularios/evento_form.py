...
class EventoForm(Form):
    ...
    fecha = TextField('Fecha del evento', [validators.Regexp('(0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])[\/\-]\d{4}', flags=0, message='Por favor ingrese una fecha valida con formato mm/dd/aaaa')])
